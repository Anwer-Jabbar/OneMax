...
public class GA {
    ...
    static final int NUM_INDIVIDUALS = 10; /* Will change the NUM_INDIVIDUALS from 20 to 10.
                                              A very large population size does not improve performance (speed of finding a solution)  
